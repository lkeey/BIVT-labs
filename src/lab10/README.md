...
![Демонстрация работы Stack и Queue](../../images/lab10/queue&stack_demo.png)

### Демонстрация работы SinglyLinkedList
![Демонстрация работы SinglyLinkedList](../../images/lab10/linked_list_demo.png)
...
Вставка 10000 элементов: 0.000530 сек
Извлечение 10000 элементов: 0.001411 сек

=== Benchmark Queue (n=10000) ===
Вставка 10000 элементов: 0.000538 сек
Извлечение 10000 элементов: 0.001368 сек

=== Benchmark SinglyLinkedList (n=10000) ===
Вставка 10000 элементов в конец: 0.002001 сек
Вставка 10000 элементов в начало: 0.001930 сек
Удаление 10000 элементов с начала: 0.001666 сек

=== Benchmark Python List (n=10000) ===
Вставка 10000 элементов в конец: 0.000231 сек
Извлечение 10000 элементов с конца: 0.000394 сек
Вставка 10000 элементов в начало: 0.016127 сек
```
...
```
=== Сравнение структур данных ===
Операция                       Stack        Queue        LinkedList   Python List 
---------------------------------------------------------------------------------
Вставка (push/enqueue/append)  0.000530     0.000538     0.002001     0.000231    
Извлечение (pop/dequeue/pop)   0.001411     0.001368     0.001930     0.000394    
Вставка в начало               -            -            0.001666     0.016127
```
...
1. **Stack на базе list**:
   ...
   - Извлечение 10,000 элементов занимает ~0.0014 секунды
...
3. **SinglyLinkedList**:
   ...
   - Вставка 10,000 элементов в конец занимает ~0.0020 секунды
   - Вставка 10,000 элементов в начало занимает ~0.0019 секунды
...
4. **Python List**:
   - Очень быстр для вставки/удаления в конец — O(1)
   - Катастрофически медленен для вставки/удаления в начале — O(n)
   - Вставка 10,000 элементов в начало занимает ~0.016 секунды (в 30 раз медленнее, чем deque)
   - Удаление 10,000 элементов из начала занимает ~0.012 секунды (в 10 раз медленнее, чем deque)
...
- **Python List**: Для общих целей, особенно когда основные операции в конце списка
...
- Python List очень эффективен для операций с концом списка, но катастрофически неэффективен для операций с началом
